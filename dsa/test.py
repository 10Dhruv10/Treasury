...
Idea: take a pivot point, last value of array
      try to bring it somwhere in middle where all values left to it
...
Execution:
    ...
    on left side and all greater on right side, 
    the pivot value is still at last though, so smth like 2 1 3 4 5* 7 8 6
    
    now we swap i+1 and pivot values as i+1 is the correct index of pivot,
